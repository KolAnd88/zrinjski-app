            ...
            <Card accent style={styles.liveCard}>
              ...
              <View style={styles.liveScore}>
                <View style={styles.liveSide}>
                  <Crest code={d.teamById(live.home_team_id)?.short_code} color={d.teamById(live.home_team_id)?.color} size={52} />
                ...
                <View style={styles.liveSide}>
                  <Crest code={d.teamById(live.away_team_id)?.short_code} color={d.teamById(live.away_team_id)?.color} size={52} />
