...
export const strings = {
  hr: {
    ...
    'home.goldSponsors': 'Zlatni sponzori',
    ...
    'admin.pendingTitle': 'Prijave koje čekaju',
    'admin.approve': 'Odobri',
    'admin.processing': 'Obrada…',
    'admin.waitlist': 'lista čekanja',
    'admin.men': 'muška',
    'admin.women': 'ženska',
    ...
    'admin.squad': 'Sastav',
    'admin.squadTitle': 'SASTAV ZA UTAKMICU',
    'admin.squadHint': 'odaberi tko igra',
    'admin.squadAll': 'Sve',
    'admin.squadNone': 'Nitko',
    'admin.squadCount': '{n} na zapisniku',
    'admin.squadEmpty': 'Nitko nije odabran — na zapisnik ide cijela ekipa.',
    'admin.squadSave': 'Spremi sastav',
    'admin.squadLocked': 'Utakmica je počela — sastav se više ne mijenja.',
    'admin.squadError': 'Sastav nije spremljen. Provjeri vezu pa pokušaj ponovno.',
  ...
  en: {
    ...
    'home.goldSponsors': 'Gold sponsors',
    ...
    'admin.pendingTitle': 'Entries awaiting a decision',
    'admin.approve': 'Approve',
    'admin.processing': 'Processing…',
    'admin.waitlist': 'waiting list',
    'admin.men': "men's",
    'admin.women': "women's",
    ...
    'admin.squad': 'Squad',
    'admin.squadTitle': 'MATCH SQUAD',
    'admin.squadHint': 'pick who plays',
    'admin.squadAll': 'All',
    'admin.squadNone': 'None',
    'admin.squadCount': '{n} on the sheet',
    'admin.squadEmpty': 'Nobody selected — the whole team goes on the sheet.',
    'admin.squadSave': 'Save squad',
    'admin.squadLocked': 'The match has started — the squad is final.',
    'admin.squadError': 'Squad not saved. Check your connection and try again.',
